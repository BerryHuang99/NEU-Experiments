...
<body>
        ...
        <div class="wrap">
            ...
            <div id="search">
           	...
           	<jsp:include page = "UserInfo.jsp">
           		...
           		<jsp:param value="<%= request.getParameter(\"collection\") %>" name="infor"/>
           	</jsp:include>
    </header>
	...
	<div class="main-body">
	<div style="padding:7px 0px;border-bottom:1px #c1c1c1 solid"><span style="font-size:20px; font-weight:bold; padding:10px 0px;border-bottom:3px #23ac3a solid ">我的收藏&nbsp;</span></div>

			<%
			
	           UserDao userDao = new UserDao();
			   String userName = (String)session.getAttribute("AyllLoginName");
	           ArrayList<String> list = userDao.getAllCollection(userName);
	           ...
	           if(!list.isEmpty()) {
	                ...
	                for(String s : list) {
	                	...
	                	Nurse nurse = userDao.getNurseByID(s);
