...
<body>
    ...
    <header>
        <div class="wrap">
            ...
            <jsp:include page = "UserInfo.jsp">
           		<jsp:param value="browse.jsp" name="url"/>
           		<jsp:param value="<%= request.getParameter(\"nurseKind\") %>" name="infor"/>
           	</jsp:include>
    </header>
    ...
    <div class="main-body">
    	<% if(request.getParameter("nurseKind") != null) { %>
         <div style="padding:7px 0px;border-bottom:1px #c1c1c1 solid"><span style="font-size:20px; font-weight:bold; padding:10px 0px;border-bottom:3px #23ac3a solid "><%= request.getParameter("nurseKind") %>&nbsp;</span></div>
	   <% } else { %>
	   		<div style="padding:7px 0px;border-bottom:1px #c1c1c1 solid"><span style="font-size:20px; font-weight:bold; padding:10px 0px;border-bottom:3px #23ac3a solid "><%= request.getParameter("infor") %>&nbsp;</span></div>
	   <% } %>
	   
	   <% if(request.getParameter("nurseKind") != null) { %>
		 <jsp:include page = "nurseBrowse.jsp">
           		<jsp:param value="<%= request.getParameter(\"nurseKind\") %>" name="nurseKind"/>
         </jsp:include>
         <% } else { %>
         	<jsp:include page = "nurseBrowse.jsp">
         		<jsp:param value="<%= request.getParameter(\"infor\") %>" name="infor"/>
         	</jsp:include>
         <% } %>
    </div>
