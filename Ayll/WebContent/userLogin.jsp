...
<body>
    ...
    <div class="main-body">
        <div style="padding:7px 0px;border-bottom:1px #c1c1c1 solid"><span style="font-size:20px; font-weight:bold; padding:10px 0px;border-bottom:3px #23ac3a solid ">用户登录&nbsp;</span></div>
            ...
            <div class="rgs-body">
                <form action = "UserLoginServlet" method = "post">
                	<% 
                		...
                		if (name != null) {
                	%>
                    <input id="userName" type="text" name="userName" placeholder="输入用户名" value = "<%= request.getAttribute("name") %>">
                    <% } else { %>
                    <input id="userName" type="text" name="userName" placeholder="输入用户名密码">
                    <% } %>
