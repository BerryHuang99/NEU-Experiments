...
<body>
    ...
    <div class="register center">
        ...
        <div class="rgs-body">
            <form action = "UserInterestServlet" method = "post">
                <label for="affection" style="font-size:20px;">您所关注的阿姨类型：</label>
                <div class="choose">
                    母婴护理：<input type="checkbox" name="affection" id="affection" value="母婴护理">
                </div>
                <div class="choose">
                    婴儿护理：&nbsp;&nbsp;<input type="checkbox" name="affection" id="affection" value="婴儿护理">
                </div>
                <div class="choose">
                    老人护理：&nbsp;<input type="checkbox" name="affection" id="affection" value="老人护理">
                </div>
                <div class="choose">
                    日常家务：<input type="checkbox" name="affection" id="affection" value="日常家务">
                </div>
                <div class="choose">
                    全能阿姨：<input type="checkbox" name="affection" id="affection" value="全能阿姨">
                </div>
                <div class="choose">
                    钟点工：<input type="checkbox" name="affection" id="affection" value="钟点工">
                </div>
                <div class="choose">
                    营养专家：<input type="checkbox" name="affection" id="affection" value="营养专家">
                </div>
