...
<body>
    ...
    <header>
        <div class="wrap">
            <a href="index.html"><img src="images/logo.png" alt="阿姨来了"></a>
            <div class="location">
    ...
    <div class="main-body">
        <div style="padding:7px 0px;border-bottom:1px #c1c1c1 solid"><span style="font-size:20px; font-weight:bold; padding:10px 0px;border-bottom:3px #23ac3a solid ">找回密码&nbsp;</span></div>
        <div class="register center">
            ...
            <div class="rgs-body">
                <form action = "ForgetPasswordServlet" method="post" >
                    ...
                    <input id="userName" type="text" name="phone" placeholder="注册手机号">
                    <input id="userPassword" type="password" name="userPassword" placeholder="输入新密码">
                    <input id="userPassword" type="password" name="correct" placeholder="确认密码">
                    <% if(message != null) { %>
                    ...
                    <input class="btn rgs-next" type = "submit" value = "修改">
                </form>
            </div>
        </div>
    </div>
